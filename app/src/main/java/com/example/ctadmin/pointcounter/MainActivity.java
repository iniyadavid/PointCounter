package com.example.ctadmin.pointcounter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView myTextView3=(TextView)findViewById(R.id.teamA);
        Typeface typeFace= Typeface.createFromAsset(getAssets(),"fonts/candysniper.ttf");
